...
Умеет проводить морфологический разбор слова (определяет часть речи, под, число, падеж, время, лицо) 
...
Используется для местоимений, предикативов, предлогов, союзов, частиц, междометий и числительных. 
